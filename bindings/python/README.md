...
DeepSeek OCR engines.  It ships as a standard `pyproject.toml` project that can
be built locally with [maturin](https://github.com/PyO3/maturin) and managed via
...
| Path | Purpose |
| --- | --- |
| `pyproject.toml` | Python packaging metadata and tooling configuration. |
